    ...
    def load(cls, pretrained_model_name_or_path, tokenizer_class=None, **kwargs):
        ...
        if tokenizer_class is None:
            if "albert" in pretrained_model_name_or_path.lower():
                ...
                raise ValueError(f"Could not infer tokenizer_class from name '{pretrained_model_name_or_path}'. Set arg `tokenizer_class` in Tokenizer.load() to one of: 'bert', 'roberta', 'xlnet' ")
